...
\tightlist
\item
  Reagan will provide only the open-ended student responses to the other
  members of the research team to evaluate. The order of the responses
  will be randomized.
\item
  The research team will evaluate the open-ended responses using the
  same rating scale that students use to evaluate their confidence that
  they understand the concepts.
\item
  The research team will also utilize AI to do the same evaluation.
\item
  The research team evaluations will be averaged (and possibly including
  the AI evaluation).
\item
  We will compare the pre and post survey response evaluations between
  and across semesters for both the research team and the student
  self-evaluations.
\end{enumerate}
